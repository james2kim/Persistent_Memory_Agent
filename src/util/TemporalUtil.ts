 ...
 */
export function extractTemporalRange(text: string): TemporalRange {
  const years: number[] = [];
 ...
 */
export function extractQueryYear(query: string): number | null {
 ...
 */
export function rangeIncludesYear(
  range: TemporalRange,
  year: number,
